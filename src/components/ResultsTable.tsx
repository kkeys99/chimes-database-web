...
const SortButton = (props: {component: Arrows, direction: Direction}) => {
    ...
    return (
        ...
        >
            <SvgIcon sx={{p:0, height:12, width:12}} component={props.component} viewBox={"6 6 12 12"} />
        </IconButton>
    )
}
        ...
        <TableContainer >
            <Table >
                                ...
                                <Stack direction="row">
                                    ...
                                    <ButtonGroup orientation="vertical">
                                        <IconButton
                                            sx={{p:0, height:12, width:12}}
                                            disableRipple
                                            onClick={ ()=> { sortButtonOnClick(field, "asc") } }
                                        >
                                            <SvgIcon sx={{p:0, height:12, width:12}} component={ArrowDropUpIcon} viewBox={"6 6 12 12"} />
                                        </IconButton>
                                        <IconButton
                                            sx={{p:0, height:12, width:12}}
                                            disableRipple
                                            onClick={ ()=> { sortButtonOnClick(field, "desc") } }
                                        >
                                            <SvgIcon sx={{p:0, height:12, width:12}} component={ArrowDropDownIcon} viewBox={"6 6 12 12"} />
                                        </IconButton>
                                    </ButtonGroup>
                                </Stack>
                            </TableCell>
                ...
                <TableBody>
                    ...
                    props.data.sort(getCompareFunction(sortDirection, orderBy))
                    .map((rowData, index) => 
                        <TableRow 
                            sx={{
